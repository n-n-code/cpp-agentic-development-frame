...
- `Implement this feature in src/ and wire the tests`:
  read `AGENTS.md`, read `config/change-contract-policy.sh`, update the relevant `feature_records/active/*.md` plan, implement narrowly, run the code profile, and record verifier commands/results.
